  ...
  const [messages, setMessages] = React.useState<Message[]>([
    {
      id: "1",
      role: "assistant",
      content: "ARGO v10 Enterprise Platform initialized. Ready to assist with project management tasks.",
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-border flex justify-between items-center bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-10">
        <div>
          <h2 className="text-lg font-semibold tracking-tight">ARGO v10</h2>
