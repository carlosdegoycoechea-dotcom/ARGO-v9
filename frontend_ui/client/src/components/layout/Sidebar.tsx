    ...
    <div className="w-80 h-screen border-r border-border bg-sidebar text-sidebar-foreground flex flex-col font-sans">
      <div className="p-5 flex flex-col gap-1">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-[10px] border-border text-muted-foreground bg-sidebar-accent">v9.0 CLEAN</Badge>
        </div>
        <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Enterprise PMO Platform</p>
      </div>
