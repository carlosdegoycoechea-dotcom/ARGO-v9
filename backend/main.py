"""
ARGO v10 - FastAPI Backend
Enterprise PMO Platform REST API + WebSocket
"""
import sys
from pathlib import Path

# Add ARGO_v9.0_CLEAN to path
sys.path.insert(0, str(Path(__file__).parent.parent / "ARGO_v9.0_CLEAN"))
...
async def startup():
    ...
    try:
        logger.info("Starting ARGO v10 Backend...")
        ...
        logger.info("✅ ARGO v10 Backend initialized successfully")
...
async def shutdown():
    """Cleanup on shutdown"""
    logger.info("Shutting down ARGO v10 Backend...")
